...
var PanelContainer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(PanelContainer, [{
    ...
    key: "generatePanels",
    value: function generatePanels(i) {
      var panels = [];
    ...
    value: function render() {
      return /*#__PURE__*/_react.default.createElement(_style.StyledPanelContainer, null, /*#__PURE__*/_react.default.createElement("div", {
        className: "panel-wrapper slide-in",
        style: {
          transform: "translateX(".concat(this.props.position, ")")
        }
